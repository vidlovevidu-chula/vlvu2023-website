...
function AnimationWrapper({ page, children }: { page: number; children: ReactNode }) {
  return (
    // <AnimatePresence>
    ...
    <div className={clsx("h-screen overflow-hidden", getBG(page))}>
      <main className="mx-auto h-full relative max-w-lg font-display">
        {/* <button
          ...
          className="absolute right-4 bottom-4 px-6 py-2 bg-vlvu-pink-600 text-white rounded-full z-50"
        >
          reset
        </button> */}
